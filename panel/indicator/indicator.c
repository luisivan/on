...
indicator_new ()
{
  ...
  indicator->container = gtk_plug_new(NULL);
  ...
  /* Fix menu style to follow panel style instead of menu's */
  GtkStyleContext *context = gtk_widget_get_style_context (indicator->container);
  gtk_style_context_add_class(context, "gnome-panel-menu-bar");
  gtk_style_context_add_class(context, "unity-panel");

  GtkStyleContext *mcontext = gtk_widget_get_style_context (GTK_WIDGET(indicator->menu));
